        ...
        <div className="tunne">
            ...
            <div className="title">
                ...
                <Modal modalId="info-modal" closable>
                    ...
                    <p><b>Sonja Jokiniemi</b> on taiteilija ja esiintyjä, joka työskentelee koreografian, esitytaiteen, installaation, tekstiilin ja piirroksen materiaalisuuksissa.
                    </p>
            ...
            <div className="palsta intro">
                <p>
                    Seuraavassa kirjoituksessa <b>Anne Naukkarinen</b>, <b>Elina Pirinen</b> ja <b>Sonja Jokiniemi</b> keskustelevat poikkeustilan töytäiseminä tästä hetkestä, mutta myös havainnoistaan ja kaipuustaan suhteessa mm. taiteeseen. Keskustelu on pitkä. Se ei ole ajallemme tyypillinen “pick and choose and create your own reality fast”, vaan ottaa tilaa ja aikaa sisältöjensä vuoksi. Kirjoitus pitää sisällään kolme erillistä ja toisiinsakin kietoutuvaa vyyhtiä. Keskustelu käytiin huhti-toukokuussa 2020. Tämän tekstin julkaisun hetkellä tunnelmat, tilanteet ja prosessoinnit voivat olla kirjoittajilla ja maailmassa jo toisin.
            ...
            <div className="palsta dialogue">
                ...
                <div><p><span className="ligature">Anne:</span> Sonja, tosi tärkeitä ajatuksia kuratointia ohjaaviin motiiveihin! Kysyin Mad Housen tuotantokoordinaattorilta Emmiltä pari viikkoa sitten, että onko Mad House Helsingin tiloissa pölyä, onko siellä aavemainen tunnelma. Mitä tapahtuu esitystilassa silloin kun siell’ ei ole esityksiä? Hän kertoi, että tilaan on jäänyt <i>Layers</i>-esityksen raksatilanne. Se tilanne ei edennyt pidemmälle, sillä <i>Layersin</i> esitykset siirtyivät syksyyn. Mutta päivät, valot, tunnelmat vaihtuivat tilassa ilman meitä ihmisiäkin.
                    ...
                    <p>.</p>
                    <p></p>
                    <p><i>tahaton yskäisy, rään valuminen nenästä ja nopea kädellä pyyhkäisy, silmien pälyilevä vilkaisu ympärille</i></p>
                    <p></p>
                    <p><i>millä ehdoilla ollaan lähell’ toisiamme</i></p>
                    <p></p>
                    <p><i>halaus on muuttunut oudoiksi kyynärpääkosketukseksi – hitto, kaipaan halauksiakin</i></p></div>

                <div><p><span className="ligature">Sonja:</span> Mietin Annen kirjoittamaa räkää.</p>
                    <p>Kaipaan IRL taidetta. Kaipaan ihoja, hajuja, likaa, kaikkea sitä mitä ruumiit tuottavat ja ovat yhdessä. Toivon ettei korona muuta esitystaidetta hygieenisen kliiniseksi. Mietin itse sitä, että jollakin tavalla meidän luultavasti pitää oppia elämään viruksen kanssa. Mutta se että kaikesta elämästä tulisi rajoitteista viruksen puitteissa tuntuisi eläväisyyden arvojen vastaiselta minulle. On toki hyvä miettiä vaihtoehtoja ja sitä miten elävä taide voi olla turvallista kokijoille. Itse kuitenkin kaipaan ruumiillisuutta sen moninaisissa inhimillisissä ja ei-inhimillisissä muodoissa.
</p>
                    <p></p>
                    <p>Minulle taiteilijana merkityksellisiä mietteitä ovat olleet esimerkiksi <b>Mika Rottenberg</b> haastattelussa @barrons.com: <i>“In times of breakdown or war, sometimes art becomes more conservative. Maybe artists want to do stuff with color and texture and kind of retreat, to say, “I can’t deal with this.” “Maybe art should just be about that—feelings and textures. What kind of art was made during real wars? Usually there was not that much, or something [emerges] like Dadaism that tries to find a new logic.”</i> Tai <b>Jean-Luc Goddard</b> joka Écal:in (taiteen yliopisto Lausannessa) videoimassa haastattelussa sanoo: <i>“I don´t believe in language. I think the real problem and what needs to be changed is the alphabet.  There are too many letters and we should delete lots of them. And then move on.“</i>
                    </p>
                </div>

                <div><p><span className="ligature">Elina:</span>  Ihastelen Sonjan kultivoitunutta tapaa tuoda itsellekin mielekkäitä asioita näkyviin. On jopa suorastaan nautinnollista olla samanmielinenkin hänen kanssaan. Kääk. Se myös inspiroi minua mielikuvittelemaan kielellä jonain anarkiana tähän kaikkeen mistä puhumme täällä.</p>
                ...
                <div><p>Pelkään kirjoittaa seuraavaa, mutta ajattelen ammattikehtaamista.
                    ...
                    Siinä me kaikki tarvitsemme opiskelua ja opastusta.
</p></div>
