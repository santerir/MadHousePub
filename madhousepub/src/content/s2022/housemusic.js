...
export const Housemusic = () => {
    ...
    const [selected, select] = useState("Intro")
    ...
    return (
        <div className="housemusic">
            ...
            <div className='grid grid--3w grid--mb-3h buttons palsta'>
                <button className={`lozenge ${selected == "Intro" ? "active" : ""}`}
                    onClick={() => {
                        select("Intro")
                    }}
                >Introduction</button>
                <button className={`lozenge ${selected == "AHouseMusic" ? "active" : ""}`}
                    onClick={() => {
                        select("AHouseMusic")
                    }}
                >A House Music</button>
                <button className={`lozenge ${selected == "FreeToDoWhatever" ? "active" : ""}`}
                    onClick={() => { select("FreeToDoWhatever") }}
                >FREE TO DO WHATEVER</button>
            </div>
            <section className={selected == "Intro" ? "active" : ""}>
            ...
            <section className={selected == "AHouseMusic" ? "active" : ""}>
            ...
            <section className={selected == "FreeToDoWhatever" ? "active" : ""}>
