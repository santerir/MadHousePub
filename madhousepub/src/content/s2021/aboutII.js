...
const CONTENT = {
    ...
    SVE: <>
        <p>
            <span className="ligature">
                Välkommen
            </span> till <i>Mad House Helsinki-publikationen</i>!
        </p>
        <p>
            I den andra delen av publikationen föser vi ihop konstnärer och läsare från olika städer, länder och kontinenter. Den skapades under en period då scenkonst ställdes in nästan fullständigt i flera månader, både i Finland och globalt. De konstnärer, som presenteras i publikationen, har alla tvingats anpassa sig till ständigt föränderliga omständigheter. Med hjälp av olika media som video, ljud, teckning, måleri och text konstruerar konstnärerna <b>Marcela Levi & Lucia Russo</b>, <b>seassa-kollektivet</b>, <b>Sebastian López-Lehto & Emmi Kaasalainen</b> och <b>Renée Van Trier</b> fragmentariska, överlappande, minnesvärda och taktila världar för läsare att uppleva.
        ...
        <p style={{ fontSize: "0.6em" }}>
            ...
            <b>Publikation sammanställd av:</b>
            <br />
            Anne Naukkarinen
